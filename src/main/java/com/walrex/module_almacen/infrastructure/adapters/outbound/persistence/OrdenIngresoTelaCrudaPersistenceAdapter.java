package com.walrex.module_almacen.infrastructure.adapters.outbound;
...
import com.walrex.module_almacen.infrastructure.adapters.outbound.persistence.BaseOrdenIngresoPersistenceAdapter;
...
public class OrdenIngresoTelaCrudaPersistenceAdapter  extends BaseOrdenIngresoPersistenceAdapter {
    ...
    @Override
    protected Mono<DetalleOrdenIngreso> procesarDetallesEspecificos(DetalleOrdenIngreso detalle, DetailsIngresoEntity savedDetalleEntity) {
        // Para tela cruda, procesar rollos si existen
    ...
    // Método para guardar los detalles de rollos (específico para tela cruda)
